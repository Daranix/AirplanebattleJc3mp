...
jcmp.events.AddRemoteCallable('airplanebattle_ready', function(data) {

    data = JSON.parse(data);

    data.players.forEach(function(p) {
        jcmp.events.CallRemote('airplanebattle_debug', 'Cached player with id' + p.id);
...
jcmp.events.AddRemoteCallable('airplanebattle_player_destroyed', function(networkId) {
...
jcmp.events.AddRemoteCallable('airplanebattle_cachelist', function() {
    jcmp.events.CallRemote('airplanebattle_debug', JSON.stringify(playersCache));
});

jcmp.events.CallRemote('airplanebattle_clientside_ready');
