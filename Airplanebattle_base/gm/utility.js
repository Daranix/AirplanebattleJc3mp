...
module.exports = class Utility {
  ...
  static randomSpawn(baseVec, radius) {
    const half = radius / 2;
    var posx = baseVec.x + airplanebattle.utils.random(-half, half);
    var posy = baseVec.y;
    var posz = baseVec.z + airplanebattle.utils.random(-half, half);
  ...
  static IsPointInCircle(v1, v2, radius) {
    ...
    /*if (airplanebattle.utils.GetDistanceBetweenPointsXZ(v1, v2) <= radius) return true;
    return false;*/
    var comparation = (airplanebattle.utils.GetDistanceBetweenPointsXZ(v1,v2) <= radius);
    return comparation;
  }

  static IsPointInCircleRender(v1, v2, radius) {

    var comparation = (airplanebattle.utils.GetDistanceBetweenPointsXZ(v1,v2) <= radius * 0.95/2);
    return comparation;
  }
  ...
  static isAdmin(player) {
    /*
    if(airplanebattle.config.admins.indexOf(player.client.steamId) >= 0) {
      return true;
    }
    return false;*/
